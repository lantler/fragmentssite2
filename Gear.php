  ...
  <div class="holy-grail-grid">
      ...
      <div class="holy-grail-middle">
        ...
        <?php
          ...
          //intro
            echo '<p>';
            echo keywords($Effect['Page Description 1'], $KeywordName, $KeywordCode, $KeywordLink);
            echo '</p><p>';
            echo keywords($Effect['Page Description 2'], $KeywordName, $KeywordCode, $KeywordLink);
            echo '</p><p>';
          ...
          //weapons
            ...
            foreach ($Name as $value) {
              If($Table[$value]=="Weapons"||$Table[$value]=="Title"){
                echo '<tr>';
                echo '<td>'.$value.'</td>';
          ...
          //armor
            ...
            echo '<table border="1" cellpadding="3" style="border-collapse: collapse">';
            foreach ($Name as $value) {
              If($Table[$value]=="Armor"||$Table[$value]=="Title"){
                echo '<tr>';
                echo '<td>'.$value.'</td>';
                echo '<td>'.$Type[$value].'</td>';
                echo '<td>'.$Qualities[$value].'</td>';
          ...
          //Gear
            ...
            echo '<table border="1" cellpadding="3" style="border-collapse: collapse">';
            foreach ($Name as $value) {
              If($Table[$value]=="Gear"||$Table[$value]=="Title"){
                echo '<tr>';
                echo '<td>'.$value.'</td>';
                echo '<td>'.$Hardness[$value].'</td>';
                echo '<td>'.$HP[$value].'</td>';
          ...
          //Bombs
            ...
            echo '<table border="1" cellpadding="3" style="border-collapse: collapse">';
            foreach ($Name as $value) {
              If($Table[$value]=="Bombs"||$Table[$value]=="Title"){
                echo '<tr>';
                echo '<td>'.$value.'</td>';
                echo '<td>'.$Damage[$value].'</td>';
                echo '<td>'.$Blast[$value].'</td>';
                echo '<td>'.$Cost[$value].'</td>';
                echo '</tr>';
              }
            }
          ...
          //Poisons
            ...
            echo '<table border="1" cellpadding="3" style="border-collapse: collapse">';
            foreach ($Name as $value) {
              If($Table[$value]=="Poisons"||$Table[$value]=="Title"){
                echo '<tr>';
                echo '<td>'.$value.'</td>';
                echo '<td>'.$Damage[$value].'</td>';
                echo '<td>'.$Cost[$value].'</td>';
          ...
          //Traps
            ...
            echo '<table border="1" cellpadding="3" style="border-collapse: collapse">';
            foreach ($Name as $value) {
              If($Table[$value]=="Traps"||$Table[$value]=="Title"){
                echo '<tr>';
                echo '<td>'.$value.'</td>';
                echo '<td>'.keywords($Effect[$value], $KeywordName, $KeywordCode, $KeywordLink).'</td>';
          ...
          //Potions
            ...
            echo '<table border="1" cellpadding="3" style="border-collapse: collapse">';
            foreach ($Name as $value) {
              If($Table[$value]=="Potions"||$Table[$value]=="Title"){
                echo '<tr>';
                echo '<td>'.$value.'</td>';
                echo '<td>'.keywords($Effect[$value], $KeywordName, $KeywordCode, $KeywordLink).'</td>';
                echo '<td>'.$Spell[$value].'</td>';
                echo '<td>'.$Cost[$value].'</td>';
                echo '</tr>';
              }
            }
          ...
          //Enchantments
            ...
            echo '<table border="1" cellpadding="3" style="border-collapse: collapse">';
            foreach ($Name as $value) {
              If($Table[$value]=="Enchantments"||$Table[$value]=="Title"){
                echo '<tr>';
                echo '<td>'.$value.'</td>';
                echo '<td>'.keywords($Effect[$value], $KeywordName, $KeywordCode, $KeywordLink).'</td>';
                echo '<td>'.$Spell[$value].'</td>';
